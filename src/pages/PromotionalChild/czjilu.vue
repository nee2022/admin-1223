    ...
    <div>
      <template>
        <el-table :data="menuList" stripe style="width: 100%">
          ...
          <el-table-column prop="payee" label="支付用户"> </el-table-column>
          <el-table-column prop="amount" label="订单金额"> </el-table-column>
          <el-table-column prop="income" label="订单收入"> </el-table-column>
          <el-table-column prop="pay" label="充值金额"> </el-table-column>
          <el-table-column prop="gateway" label="支付方式"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getUserMes() {
      ...
      this.$axios
        .get(
          "admin/api/service/1/payments?token=" +
            toKen +
            "&page=" +
            this.pagenum +
            "&row=14&keyword=" +
    ...
    async removeUserByID(id) {
      ...
      this.$axios
        .delete("/admin/api/user/" + id + "?token=" + toKen)
        .then(res => {
