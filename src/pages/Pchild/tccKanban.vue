	...
	<div class="oneCard-right">
		...
		<div class="wulianBot">
			<div class="wulianBotBox">
				...
				<div class="ziyuanBox">
					<div class="boxBoxs">
						<div class="boxWord">停车场数量</div>
						<div class="boxNum">9420</div>
					</div>
					<div class="boxBoxs">
						<div class="boxWord">入口</div>
						<div class="boxNum">3120</div>
					</div>
					<div class="boxBoxs">
						<div class="boxWord">出口</div>
						<div class="boxNum">3420</div>
					</div>
					<div class="boxBoxsOn">
						<div class="onWord">在线</div>
						<div class="boxNumW">2420</div>
					</div>
					<div class="boxBoxsOff">
						<div class="offWord">离线</div>
						<div class="boxNumW">1720</div>
					</div>
				</div>
			</div>
			<div class="wulianBotBox">
...
<style scoped="scoped">
	...
	.boxBoxsOn{
		...
		display: flex;
		flex-direction: column;
		background: url(../../assets/images/onShe.png) no-repeat center;
	...
	.boxBoxsOff{
		...
		display: flex;
		flex-direction: column;
		background: url(../../assets/images/offShe.png) no-repeat center;
		background-size: 100% 100%;
		align-items: center;
	}
