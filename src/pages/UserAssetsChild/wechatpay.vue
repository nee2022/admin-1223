        ...
        <el-table :data="cardList" stripe style="width: 100%">
          ...
          <el-table-column prop="gateway" label="支付网关">
            <template slot-scope="scope">
              ...
              <div
                v-else-if="scope.row.gateway == 'wechat'"
                class="stateColor-green"
              >
                微信支付
              </div>
              <div
                v-else-if="scope.row.gateway == 'alipay'"
                class="stateColor-green"
              >
                支付宝
              </div>
              <div
                v-else-if="scope.row.gateway == 'ckej'"
                class="stateColor-green"
              >
                城客e家
              </div>
          ...
          <el-table-column prop="amount" label="无感金额"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getUserMes() {
      ...
      this.$axios
        .get(
          "/admin/api/user/trustpay/gateway/wechatpay?token=" +
            toKen +
            "&page=" +
            this.pagenum +
            "&row=14"
