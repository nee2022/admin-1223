...
export default {
  ...
  methods: {
    ...
    getUserMes() {
      ...
      this.$axios
        .get(
          "http://www.api.sqjtjt.com/admin/api/cards/?token=" +
            toKen +
            "&page=" +
            this.pagenum +
            "&row=14"
    ...
    async removeUserByID(id) {
      ...
      this.$axios
        .delete(
          "http://www.api.sqjtjt.com/admin/api/user/" + id + "?token=" + toKen
        )
        .then(res => {
          if (res.status == 200) {
    ...
    chargersUser() {
      ...
      this.$refs.addFormRef.validate(valid => {
        if (!valid) {
          ...
          this.$axios.post("admin/api/cards", this.addForm).then(res => {
            if (res.status !== 200) {
